...
lib.ssMetadata = [
		{name:"preloader_atlas_", frames: [[0,0,927,821],[1022,278,53,41],[929,439,94,31],[929,278,91,79],[929,359,91,78],[929,0,246,276]]}
];
...
(lib.gr_panal = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.instance = new lib.CachedBmp_7144();
	this.instance.setTransform(-59.95,-53.1,0.1294,0.1294);
...
p.nominalBounds = new cjs.Rectangle(-59.9,-53.1,120,106.30000000000001);
...
(lib.gr_abeja = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.instance = new lib.CachedBmp_7143();
	this.instance.setTransform(-7.1,2.85,0.2643,0.2643);

	this.instance_1 = new lib.CachedBmp_7142();
	this.instance_1.setTransform(-12.35,20.6,0.2643,0.2643);

	this.instance_2 = new lib.CachedBmp_7141();
	this.instance_2.setTransform(4.95,-4.9,0.2643,0.2643);

	this.instance_3 = new lib.CachedBmp_7140();
	this.instance_3.setTransform(-29.1,-4.9,0.2643,0.2643);

	this.instance_4 = new lib.CachedBmp_7139();
	this.instance_4.setTransform(-32.5,-36.45,0.2643,0.2643);
...
p.nominalBounds = new cjs.Rectangle(-32.5,-36.4,65,72.9);
...
(lib.preloader = function(mode,startPosition,loop) {
	...
	// Layer_2
	this.instance = new lib.gr_abeja("synched",0);
	this.instance.setTransform(372.7,98.25,1.8919,1.8919,139.203,0,0,-0.2,-0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:-0.1,regY:-0.2,scaleX:0.4266,scaleY:0.4266,rotation:154.203,x:114.75,y:65.3},6,cjs.Ease.get(1)).to({regX:-0.3,regY:-0.1,rotation:199.2003,x:114.4,y:67.5},1,cjs.Ease.get(1)).to({regX:-0.4,rotation:229.1989,x:90.85,y:107.8},6,cjs.Ease.get(1)).to({regX:-0.6,regY:0.1,rotation:267.9009,x:83.65,y:109.6},1).to({regX:-0.8,rotation:297.8988,x:39.2,y:106.8},6,cjs.Ease.get(-1)).to({regY:0.2,rotation:327.9012,x:35.55,y:101.9},1).to({rotation:342.9016,x:16,y:65.05},6,cjs.Ease.get(-1)).to({regY:0.3,scaleX:0.4265,scaleY:0.4265,rotation:387.8998,x:17.35,y:59.95},1).to({rotation:402.8979,x:41,y:22.15},7,cjs.Ease.get(-1)).to({regY:0.2,rotation:447.9007,x:50,y:21.05},1).to({regX:-0.9,regY:0.1,rotation:477.8998,x:82.95,y:21.95},7,cjs.Ease.get(-1)).to({regX:-0.8,regY:0.3,rotation:552.9012,x:82.35,y:29.7},1).to({regX:-0.7,regY:0.4,rotation:597.9014,x:64.45,y:62.7},7,cjs.Ease.get(-1)).to({regX:-0.6,regY:0.1,scaleX:0.7638,scaleY:0.7638,rotation:717.9036,x:64.5},1).wait(1).to({regX:0,regY:0,x:64.95,y:62.6},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({regX:-0.6,regY:0.1,x:64.5,y:62.7},0).wait(1));
	...
	this.instance_1.setTransform(243.25,261.3,3.863,3.863);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(59).to({scaleX:0.8711,scaleY:0.8711,x:64.45,y:63.15},0).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(248.2,251.5,226.90000000000003,215.10000000000002);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/preloader_atlas_.png?1624504054161", id:"preloader_atlas_"}
	],
	preloads: []
};
